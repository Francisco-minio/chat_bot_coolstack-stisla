...
class EstablecimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establecimiento" do
    assert_difference('Establecimiento.count') do
      post establecimientos_url, params: { establecimiento: { ciudad: @establecimiento.ciudad, direccion: @establecimiento.direccion, email: @establecimiento.email, nombre: @establecimiento.nombre, rbd: @establecimiento.rbd, telefono: @establecimiento.telefono } }
    end
  ...
  test "should update establecimiento" do
    patch establecimiento_url(@establecimiento), params: { establecimiento: { ciudad: @establecimiento.ciudad, direccion: @establecimiento.direccion, email: @establecimiento.email, nombre: @establecimiento.nombre, rbd: @establecimiento.rbd, telefono: @establecimiento.telefono } }
