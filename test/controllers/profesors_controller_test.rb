...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { apellido: @profesor.apellido, email: @profesor.email, horario_id: @profesor.horario_id, nombre: @profesor.nombre } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { apellido: @profesor.apellido, email: @profesor.email, horario_id: @profesor.horario_id, nombre: @profesor.nombre } }
