...
ActiveRecord::Schema.define(version: 2021_08_06_001524) do
  ...
  create_table "cursoprofesors", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "profesor_id", null: false
    t.bigint "curso_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["curso_id"], name: "index_cursoprofesors_on_curso_id"
    t.index ["profesor_id"], name: "index_cursoprofesors_on_profesor_id"
  end
  ...
  create_table "profesors", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["horario_id"], name: "index_profesors_on_horario_id"
  end
  ...
  add_foreign_key "cursoprofesors", "cursos"
  add_foreign_key "cursoprofesors", "profesors"
  add_foreign_key "profesors", "horarios"
