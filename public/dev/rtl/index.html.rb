                ...
                <form class="form-inline ml-auto">
                    ...
                    <div class="search-element text-right">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="ml-3 rounded" width="30" src="../assets/img/products/product-3-50.png" alt="product"> آیفون s9 تولید شد
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="ml-3 rounded" width="30" src="../assets/img/products/product-2-50.png" alt="product"> چه شادی هایی که زیر پای انسانها سرکوب شدند
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="ml-3 rounded" width="30" src="../assets/img/products/product-1-50.png" alt="product"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.
                                </a>
                            </div>
                            <div class="search-header">
                                پروژه ها
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">سلام مهدی</div>
                        </a>
                        ...
                        <tbody>
                            <% @usuarios.each do |usuario| %>
                                <tr>
                                    ...
                                    <td>
                                        <%= link_to 'Destroy', usuario, method: :delete, data: { confirm: 'Are you sure?' } %>
                                    </td>
                                </tr>
                                <% end %>
                        </tbody>
                                    ...
                                    <ul class="list-unstyled list-unstyled-border text-right p-0">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="float-left">
                                                    <div class="font-weight-600 text-muted text-small">۸۶ فروش</div>
                                                </div>
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="float-left">
                                                    <div class="font-weight-600 text-muted text-small">۶۷ فروش</div>
                                                </div>
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="float-left">
                                                    <div class="font-weight-600 text-muted text-small">۶۳ فروش</div>
                                                </div>
                                    ...
                                    <div class="table-responsive table-invoice text-right">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="badge badge-warning">پرداخت نشده</div>
                                                </td>
                                                <td>۱۹ مرداد, ۱۳۹۸</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="badge badge-warning">پرداخت شده</div>
                                                </td>
                                                <td>۲۵ مرداد, ۱۳۹۸</td>
                                                <td>
                                                    <a href="#" class="btn btn-primary">مشاهده جزئیات</a>
